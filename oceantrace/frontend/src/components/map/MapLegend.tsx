...
export const MapLegend = () => {
  ...
  const rows: LegendRow[] = [
    {
      symbol: <Poly fill="rgba(220,38,38,0.35)" border="rgb(255,60,60)" />,
      label: "Oil Spill",
    },
    {
      symbol: <Poly fill="rgba(16,185,129,0.2)" border="rgb(16,185,129)" />,
    ...
    {
      symbol: <Dot color="rgba(245,158,11,0.85)" />,
      label: "Hindcast Particle",
    },
    {
      symbol: <Dot color="rgba(34,211,238,0.85)" />,
      label: "Forecast Particle",
    },
  ...
  return (
    <div
      style={{
        ...
        borderRadius: "10px",
        padding: isOpen ? "12px 14px" : "8px 14px",
