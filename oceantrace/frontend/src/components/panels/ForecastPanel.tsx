    ...
    >
      ...
      <div style={{ marginBottom: "20px" }}>
        ...
        >
          <InfoBox
            label="Predicted Lat"
            value={forecast.predicted_lat.toFixed(4)}
          />
          <InfoBox
            label="Predicted Lon"
            value={forecast.predicted_lon.toFixed(4)}
          />
          <InfoBox
            label="Confidence"
          ...
          <InfoBox
            ...
            value={`${forecast.uncertainty_radius_km.toFixed(1)} km`}
          />
        </div>
      </div>
      ...
      >
        [MODELLED / DEMO DATA] Forward deterministic trajectory. Do not use for
        real navigation or response.
      </div>
    </div>
  );
};
